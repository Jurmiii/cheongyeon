...
export const reservationBranchAddresses: Record<ReservationBranch, string> = {
  "북촌 지점": "서울특별시 종로구 북촌로 58",
  "하동 지점": "경상남도 하동군 화개면 612",
  "보성 지점": "전라남도 보성군 보성읍 821",
  "강진 지점": "전라남도 강진군 성전면 437",
};
