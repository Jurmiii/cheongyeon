...
export const classIntroductionReviews: ClassIntroductionReview[] = [
  ...
  },
  {
    ...
    name: "S0000님",
    body:
      "처음으로 한국에 놀러 왔는데 한국에 문화를 알고 싶어서 검색하다가 찾게 되었어요!\n전통 차 문화를 배우니 마음도 차분해지고 몸도 따뜻해지는 좋은 시간이었어요!\n클래스 선생님이 영어 수업이 가능하셔서 편하게 경험 했습니다 :)",
    date: "2026.06.22",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    name: "이OO님",
    body:
      "오랜만에 저를 위한 시간을 보내고 싶어 청연 다도 클래스를 예약했어요.\n차를 우리는 과정이 차분하게 이어져 마음이 편안해졌고,\n조용한 분위기 덕분에 잠시 쉬어가는 좋은 시간이었습니다.",
    date: "2026.06.19",
  },
  {
    id: 5,
    ...
    name: "최OO님",
    body:
      "공간이 차분해서 앉아있는 것만으로도 좋았어요.\n차 맛을 하나씩 느껴보는 과정이 생각보다 재미있었습니다~\n너무 진지한 분위기가 아니라 편하게 참여할 수 있었어요!",
    date: "2026.06.23",
  },
  {
    id: 6,
    ...
    name: "이OO님",
    body:
      "친구가 관심 있어서 같이 신청했는데, 오히려 제가 더 재미있게 참여한 것 같아요.\n차마다 향이 달라서 비교하는 재미도 있었습니다.\n다음에는 남자친구랑 다시 오려고요~",
    date: "2026.07.01",
  },
];
