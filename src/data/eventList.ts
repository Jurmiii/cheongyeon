...
export const events: EventItem[] = [
  {
    ...
    title: "청연에서 머무는 여름",
    description: "방문 고객을 위한 여름 한정 혜택과\n차 시음 이벤트를 준비했습니다.",
  ...
  },
  {
    ...
    title: "둘이 함께 마시는 차",
    description: "소중한 사람과 함께 방문하면 동반\n10% 할인 혜택을 준비했습니다.",
  ...
  },
  {
    ...
    subTitle: "티 페어링 이벤트",
    title: "차와 다과의 조화",
    description: "계절차와 어울리는 다과를 함께 즐기며\n새로운 맛을 경험해보세요.",
