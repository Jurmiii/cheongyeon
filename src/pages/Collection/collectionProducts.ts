...
export const collectionCategories: CollectionCategory[] = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        description:
          "풍부한 감칠맛과 깊어진 녹향이 조화를 이룹니다.\n은은한 단맛과 진한 여운을 오래 느낄 수 있는 녹차입니다.",
        imageSrc: greenTea3,
        specs: [
          { label: "종류", value: "녹차" },
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        description:
          "풍부한 향과 깊은 여운이 인상적인 백차입니다.\n백차 특유의 부드러움과 깊이를 함께 느낄 수 있습니다.",
        imageSrc: whiteTea4,
        specs: [
          { label: "종류", value: "백차" },
          { label: "원산지", value: "전라남도 보성" },
    ...
    products: [
      {
        ...
        description:
          "풍부한 꽃향과 산뜻한 풍미가 조화를 이루는 청차입니다.\n차를 마시는 순간 은은한 꽃내음을 오래 느낄 수 있습니다.",
        imageSrc: oolongTea1,
        specs: [
          { label: "종류", value: "청차" },
          { label: "원산지", value: "제주 서귀포" },
      ...
      },
      {
        ...
        description:
          "은은한 난초 향과 청량한 여운이 조화를 이루는 청차입니다.\n청차 본연의 섬세한 향을 편안하게 즐길 수 있습니다.",
        imageSrc: oolongTea2,
        specs: [
          { label: "종류", value: "청차" },
          { label: "원산지", value: "경상남도 하동" },
      ...
      },
      {
        ...
        description:
          "맑은 꽃향 뒤로 은은한 과실향이 이어지는 청차입니다.\n부드럽고 긴 여운이 인상적인 풍미를 전해줍니다.",
        imageSrc: oolongTea3,
        specs: [
          { label: "종류", value: "청차" },
          { label: "원산지", value: "전라남도 보성" },
      ...
      },
      {
        ...
        description:
          "화사한 난초 향과 부드러운 단맛이 특징인 청차입니다.\n처음부터 끝까지 우아한 향을 오래 느낄 수 있습니다.",
        imageSrc: oolongTea4,
        specs: [
          { label: "종류", value: "청차" },
          { label: "원산지", value: "제주 서귀포" },
    ...
    products: [
      {
        ...
        summary: "붉은 구름의 여운",
        description:
          "부드러운 단맛과 은은한 꽃향이 어우러진 홍차입니다.\n청연을 대표하는 가장 균형 잡힌 홍차의 풍미를 담았습니다.",
        imageSrc: blackTea1,
        specs: [
          { label: "종류", value: "홍차" },
          { label: "원산지", value: "경상남도 하동" },
      ...
      },
      {
        ...
        summary: "깊고 진한 붉은 장미",
        description:
          "풍부한 바디감과 묵직한 단맛이 인상적인 홍차입니다.\n깊은 향과 긴 여운이 차분한 시간을 만들어 줍니다.",
        imageSrc: blackTea2,
        specs: [
          { label: "종류", value: "홍차" },
          { label: "원산지", value: "제주 서귀포" },
      ...
      },
      {
        ...
        description:
          "은은한 단맛과 섬세한 향이 오래 이어지는 홍차입니다.\n부담 없이 즐기기 좋은 부드러운 풍미가 매력입니다.",
        imageSrc: blackTea3,
        specs: [
          { label: "종류", value: "홍차" },
          { label: "원산지", value: "전라남도 보성" },
      ...
      },
      {
        ...
        summary: "하루의 끝을 담은 차",
        description:
          "따뜻한 향과 부드러운 여운이 차분하게 이어지는 홍차입니다.\n조용한 저녁 시간과 가장 잘 어울리는 풍미를 담았습니다.",
        imageSrc: blackTea4,
        specs: [
          { label: "종류", value: "홍차" },
          { label: "원산지", value: "제주 서귀포" },
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        summary: "가장 깊은 곳의 시간",
        description:
          "풍부한 숙성감과 깊은 여운이 인상적인 흑차입니다.\n청연을 대표하는 프리미엄 흑차의 풍미를 담았습니다.",
        imageSrc: darkTea2,
        specs: [
          { label: "종류", value: "흑차" },
          { label: "원산지", value: "경상남도 하동" },
      ...
      },
      {
        ...
        summary: "숲의 향을 머금은 차",
        description:
          "은은한 목향과 묵직한 풍미가 조화를 이루는 흑차입니다.\n차분한 시간을 위한 깊이 있는 한 잔을 전해줍니다.",
        imageSrc: darkTea3,
        specs: [
          { label: "종류", value: "흑차" },
          { label: "원산지", value: "전라남도 보성" },
      ...
      },
      {
        ...
        summary: "오래 남는 깊은 여운",
        description:
          "숙성된 단맛과 부드러운 바디감이 인상적인 흑차입니다.\n마실수록 깊이가 더해지는 풍미를 느낄 수 있습니다.",
        imageSrc: darkTea4,
        specs: [
          { label: "종류", value: "흑차" },
          { label: "원산지", value: "전라남도 보성" },
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        description:
          "은은한 단맛과 부드러운 여운이 특징인 백차입니다.\n편안한 휴식과 함께하기 좋은 넉넉한 용량입니다.",
      ...
      },
      {
        ...
        description:
          "꽃향과 과실향이 어우러진 깊은 풍미를 담았습니다.\n청차 특유의 다채로운 향을 오래 즐길 수 있습니다.",
      ...
      },
      {
        ...
        description:
          "달빛 아래 피어난 향을 담은 프리미엄 청차입니다.\n꽃향과 과실향이 조화를 이루며 긴 여운을 남깁니다.",
      ...
      },
      {
        ...
        description:
          "오랜 숙성으로 완성된 최고급 흑차입니다.\n묵직한 풍미와 깊은 여운이 품격 있게 이어집니다.",
